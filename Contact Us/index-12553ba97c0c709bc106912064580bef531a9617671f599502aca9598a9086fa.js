!(function (e, t) {
  ...
  var ie = (function (e) {
    ...
    (t.matchesSelector = function (e, n) {
      if (
        ...
        (n = n.replace(fe, "='$1']")),
        b.matchesSelector && j && (!L || !L.test(n)) && (!H || !H.test(n)))
      )
        try {
          var r = P.call(e, n);
          if (
    ...
    return (
      ...
      (M = t.select =
        function (e, t, n, r) {
          ...
          return (
            (l || D(e, f))(r, t, !j, n, (we.test(e) && c(t.parentNode)) || t), n
          );
        }),
  ...
  return (
    (K.noConflict = function (t) {
      return e.$ === K && (e.$ = Rt), t && e.jQuery === K && (e.jQuery = Pt), K;
    }),
  ...
  (function (e, t) {
    ...
    function v(e) {
      if (null == e) return !0;
      var t = qt(e);
      return "number" == typeof t && (Lt(e) || bt(e) || Rt(e))
        ? 0 === t
        : 0 === qt(y(e));
    }
    function w(e, t) {
    ...
    function H(e) {
      return t(e) ? (Lt(e) ? e.slice() : nn({}, e)) : e;
    }
    function L(e, t) {
      return t(e), e;
    }
    ...
    function $(e, n, r) {
      return null == e ? U : Ot(e) ? V(e, n, r) : t(e) && !Lt(e) ? q(e) : G(e);
    }
    function B(e, t) {
      return $(e, t, 1 / 0);
    }
    ...
    var Gt = "[object DataView]",
      ...
      Qt = At ? D(Zt) : a("Map"),
      Kt = At ? D(Xt) : a("WeakMap"),
      en = At ? D(Jt) : a("Set"),
      tn = a("WeakSet"),
      nn = Y(T),
      rn = Y(y),
      on = Y(T, !0);
    (_.toPath = P), (_.iteratee = B);
    var an =
        Date.now ||
        function () {
  ...
  (function (e, t) {
        ...
        n &&
          ...
          ((t =
            n[Ri] < 0 || n[Ri] > 11
              ...
              ? qi
              : -1),
          h(e)._overflowDayOfYear && (t < Pi || t > Fi) && (t = Fi),
    ...
    function gt(e) {
      ...
      null != (t = e._w).GG || null != t.W || null != t.E
        ? ((o = 1),
          (a = 4),
          (n = ht(t.GG, e._a[Pi], _e(Tt(), 1, 4).year)),
          (r = ht(t.W, 1)),
          ((i = ht(t.E, 1)) < 1 || i > 7) && (u = !0))
        : ((o = e._locale._week.dow),
          (a = e._locale._week.doy),
          (l = _e(Tt(), o, a)),
          (n = ht(t.gg, e._a[Pi], l.year)),
          (r = ht(t.w, l.week)),
          null != t.d
            ? ((i = t.d) < 0 || i > 6) && (u = !0)
            : null != t.e
      ...
      if (t._f !== e.ISO_8601)
        if (t._f !== e.RFC_2822) {
          ...
          (h(t).charsLeftOver = c - f),
            ...
            null !== (s = h(t).era) &&
              (t._a[Pi] = t._locale.erasConvertYear(s, t._a[Pi])),
            mt(t),
            it(t);
        } else ft(t);
      else ot(t);
    ...
    function Fr(e) {
      ...
      if ("month" === (e = R(e)) || "quarter" === e || "year" === e)
        switch (((t = this._days + r / 864e5), (n = this._months + Pr(t)), e)) {
          case "month":
            return n;
          case "quarter":
            return n / 3;
    ...
    C("Y", 0, 0, function () {
      ...
      B(["YYYYY", "YYYYYY"], Pi),
      B("YYYY", function (t, n) {
        n[Pi] = 2 === t.length ? e.parseTwoDigitYear(t) : $(t);
      }),
      B("YY", function (t, n) {
        n[Pi] = e.parseTwoDigitYear(t);
      }),
      B("Y", function (e, t) {
        t[Pi] = parseInt(e, 10);
      }),
      ...
      B(["yo"], function (e, t, n) {
        ...
        n._locale._eraYearOrdinalRegex &&
          ...
          n._locale.eraYearOrdinalParse
            ? (t[Pi] = n._locale.eraYearOrdinalParse(e, r))
            : (t[Pi] = parseInt(e, 10));
      }),
      C(0, ["gg", 2], 0, function () {
    ...
    for (
      ...
      I(Po, Ci);
    for (Po = "S"; Po.length <= 9; Po += "S") B(Po, yr);
    (Ro = K("Milliseconds", !1)),
      C("z", 0, 0, "zoneAbbr"),
      C("zz", 0, 0, "zoneName");
    var Wo = y.prototype;
